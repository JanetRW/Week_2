...
function continent(country: string): void {
  ...
  let continente = paisporContinente[actualCountry];

  if (continente) {
    console.log(`El país ${actualCountry}, se encuentra en el continente ${continente}.`);
  } else {
    console.log(`No se encontró información para el país "${actualCountry}".`);
  }
}
